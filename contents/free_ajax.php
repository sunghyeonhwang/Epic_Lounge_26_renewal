...
include_once('../common.php');
	...
	$sc_category = $_REQUEST["category"];
	$sc_cate_engine = $_REQUEST["cate_engine"];
	$sc_cate_industry = $_REQUEST["cate_industry"];
	
	foreach($sc_cate_product as $sc1){
		$where .= " and cate_product like '%{$sc1}%'";		
	}
	foreach($sc_category as $sc1){
		$where .= " and category like '%{$sc1}%'";		
	}
	foreach($sc_cate_engine as $sc1){
		$where .= " and cate_engine like '%{$sc1}%'";		
	}
