...
// ----- 배너 슬라이더 -----
$banner_result = sql_query("SELECT * FROM v3_shop_banner WHERE bn_position = '무료콘텐츠' ORDER BY bn_id DESC");
$banners = [];
...
while ($row = sql_fetch_array($result)) {
    $categories['industry'][] = $row['rsc_name'];
}
...
$result = sql_query($sql);
while ($row = sql_fetch_array($result)) {
    $categories['engine'][] = $row['rsc_name'];
}
...
$result = sql_query($sql);
while ($row = sql_fetch_array($result)) {
    $categories['category'][] = $row['rsc_name'];
}
            ...
            <div class="v4-list-layout__sidebar">
                <div class="v4-sidebar">
                    ...
                    <div class="v4-sidebar__body">
                            ...
                            <div class="v4-filter-group__body">
                                <div class="v4-filter-chips">
                                    ...
                                    <label class="v4-filter-chip">
                                        ...
                                        <span class="v4-filter-chip__text"><?php echo get_text($cat); ?></span>
                                    </label>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        ...
                        <?php if (!empty($categories['engine'])): ?>
                        <!-- 엔진버전 -->
                        <div class="v4-filter-group" data-filter="engine">
                            <button type="button" class="v4-filter-group__header">
                                <span class="v4-filter-group__label">엔진버전</span>
                                <span class="v4-filter-group__badge" style="display:none;">0</span>
                                <svg class="v4-filter-group__arrow" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <path d="M5 8l5 5 5-5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            ...
                            <div class="v4-filter-group__body" style="display:none;">
                                <div class="v4-filter-chips">
                                    <?php foreach ($categories['engine'] as $idx => $cat): ?>
                                    <label class="v4-filter-chip">
                                        <input type="checkbox" name="cate_engine[]" value="<?php echo get_text($cat); ?>">
                                        <span class="v4-filter-chip__text"><?php echo get_text($cat); ?></span>
                                    </label>
                                    <?php endforeach; ?>
                                </div>
                        ...
                        <!-- 카테고리 -->
                        <div class="v4-filter-group" data-filter="category">
                            <button type="button" class="v4-filter-group__header">
                                <span class="v4-filter-group__label">카테고리</span>
                                <span class="v4-filter-group__badge" style="display:none;">0</span>
                                <svg class="v4-filter-group__arrow" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <path d="M5 8l5 5 5-5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            ...
                            <div class="v4-filter-group__body" style="display:none;">
                                <div class="v4-filter-chips">
                                    <?php foreach ($categories['category'] as $idx => $cat): ?>
                                    <label class="v4-filter-chip">
                                        <input type="checkbox" name="category[]" value="<?php echo get_text($cat); ?>">
                                        <span class="v4-filter-chip__text"><?php echo get_text($cat); ?></span>
                                    </label>
                                    <?php endforeach; ?>
                                </div>
                ...
                <div id="card-list" class="v4-card-grid v4-card-grid--gallery">
                    ...
                    <?php else: ?>
                        <?php foreach ($items as $item): ?>
                            <?php echo render_resource_card($item, 'free', $view_url, 'rsc'); ?>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </div>
...
(function($) {
    ...
    function loadContent(append) {
        ...
        var data = {
            ...
            cate_engine: currentFilters.cate_engine,
