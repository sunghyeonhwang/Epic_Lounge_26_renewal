...
<head>
	...
	<meta property="og:title" content="언리얼 페스트 2023 서울, 당첨자 발표">
	<meta property="og:description" content="언리얼 페스트 2023 서울, 이벤트 당첨을 축하드립니다.">
	<meta property="og:image" content="https://unrealsummit16.cafe24.com/2023/fest_src/check_unrealfest.jpg">
	<meta property="og:url" content="https://epiclounge.co.kr/contents/event_list.php">
    <title>에픽 라운지 | 이벤트</title>
...
<div id="sub_visual" class="event_vi">
	...
	<!--
		...
		<div class="event_top_cate_list">
			<ul>
				<li class="<?=empty($_GET["status"])? "on":""?>"><a href="/v3/contents/event_list.php?category=커뮤니티%20이벤트">전체</a></li>
				<li class="<?=$_GET["status"] == "진행중" ? "on":""?>"><a href="/v3/contents/event_list.php?status=진행중&category=커뮤니티%20이벤트">진행중</a></li>
				<li class="<?=$_GET["status"] == "종료" ? "on":""?>"><a href="/v3/contents/event_list.php?status=종료&category=커뮤니티%20이벤트">종료</a></li>
				<li class="<?=$_GET["status"] == "결과발표" ? "on":""?>"><a href="/v3/contents/event_list.php?status=결과발표&category=커뮤니티%20이벤트">결과발표</a></li>
			</ul>
		</div>
	</div>
	<script>
