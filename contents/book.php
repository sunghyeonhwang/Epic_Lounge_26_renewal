...
<div class="container resource_book"> 
		...
		<fieldset>
			...
			?>
				<ul>
					...
					<li class="on"><a href="./book.php"><span class="text_box">백서</span><span class="num_box"><?=$RData["book_cnt"]?></span></a></li>
				</ul>
			</div>
		</fieldset>
...
<div class="content">
    ...
    <div class="sub_visual">
		...
		<?
			$rsc_banner_result = sql_query("select * from v3_shop_banner where bn_position = '백서'");
...
<script>
    ...
    function createElem(thisData){
        elem = $('<li class="list_item">\n' +
            ...
            '            <div class="title"></div>\n' +
            '            <div class="con">\n' +
            '                 <span class="label"><em>백서</em></span>\n' +
