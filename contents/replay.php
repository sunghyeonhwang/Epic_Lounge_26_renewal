...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
  ...
  <meta name="keywords" content="언리얼 페스트 서울 2025 | 다시보기 "/>
  <meta name="description" content="언리얼 페스트 서울 2025 | 다시보기">
  <meta property="og:url" content="https://epiclounge.co.kr/contents/replay.php" />
  <meta property="og:image" content="https://unrealsummit16.cafe24.com/2025/ufest25/unrealfest25_replay2.jpg" />
  <meta property="og:image:height" content="630px" />
  <meta property="og:image:width" content="1200px" />
  <meta property="og:description" content="언리얼 페스트 서울 2025 다시보기를 만나보세요." />
...
<div id="sub_visual" class="resource_vi">
	<h2>리소스</h2>
	<p>언리얼 페스트, 에픽 라이브, 웨비나, 테크토크, 무료 콘텐츠, 백서 등의 다양한 리소스를 활용해 보세요.</p>
</div>
...
<div id="resource_search">
	<form action="#n"  onsubmit="return keyword_sc()" name="" id="">
		<fieldset>
			...
			?>
				<ul>
					<li class="on"><a href="./replay.php"><span class="text_box">영상</span><span class="num_box"><?=$RData["replay_cnt"]?></span></a></li>
  ...
  autoplaySpeed: 3000,
    ...
    function createElem(thisData){
        elem = $('<li class="list_item">\n' +
            ...
            '            <div class="title"></div>\n' +
            '            <div class="con">\n' +
            '                 <span class="label"><em>영상</em></span>\n' +
