...
<div id="sub_visual" class="resource_vi">
	<h2>리소스</h2>
	<p>언리얼 서밋, 웨비나, 테크토크, 무료 콘텐츠, 백서 등의 다양한 리소스를 활용해 보세요.
        
        
</p>
</div>
<div class="container resource_free"> 
<div id="resource_search">
	<form action="#n"  onsubmit="return keyword_sc()" name="" id="">
		<fieldset>
			...
			?>
				<ul>
					<li><a href="./replay.php"><span class="text_box">다시보기</span><span class="num_box"><?=$RData["replay_cnt"]?></span></a></li>
					<li class="on"><a href="./free.php"><span class="text_box">무료 콘텐츠</span><span class="num_box"><?=$RData["free_cnt"]?></span></a></li>
...
?>
            <div class="check_wrap">
                <input name="cate_engine[]" id="check2-<?=$i+1?>" type="checkbox" value="<?=$row["rsc_name"]?>" onchange="refresh_serach()">
...
?>
            <div class="check_wrap type2">
                <input name="category[]" id="check3-<?=$i+1?>" type="checkbox" value="<?=$row["rsc_name"]?>" onchange="refresh_serach()">
...
<div class="content">
    ...
    <div class="sub_visual">
		...
		<?
			$rsc_banner_result = sql_query("select * from v3_shop_banner where bn_position = '무료콘텐츠'");
    ...
    <div class="more_wrap">
        <button class="more"><span>더보기</span></button>
    </div>
</div>
<script>
    // reset
    ...
    function createElem(thisData){
        elem = $('<li class="list_item">\n' +
            ...
            '            <div class="title"></div>\n' +
            '            <div class="con">\n' +
            '                 <span class="label"><em>무료 콘텐츠</em></span>\n' +
