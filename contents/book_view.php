...
<div class="container"> 
	<div class="wrap">
	<div class="board_view resource_view book_view"> <!-- 뉴스면 뉴스 리소스면 리소스 이벤트면 이벤트라고 클래스 --> 
  ...
  frameborder="0"></iframe><br /><?
		...
		<div class="board_ot_list">
			...
			<ul>
			<?
			$other_result = sql_query("select * from v3_rsc_book_bbs  where rsc_bbs_idx<>{$idx} order by abs({$idx} - rsc_bbs_idx) asc,rsc_bbs_idx asc limit 3 ");
			...
			?>
				<li>
					<a href="./book_view.php?idx=<?=$other["rsc_bbs_idx"]?>">
		...
		<div class="board_btn_box">
			<a href="./book.php" ><span class="text">목록으로</span><span class="icon"></span></a>
		</div>
	</div>
	</div>
</div>
