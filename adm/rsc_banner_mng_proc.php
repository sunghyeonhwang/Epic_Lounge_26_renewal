...
if ($w=="")
{
    ...
    sql_query(" alter table v3_shop_banner auto_increment=1 ");

    $sql = " insert into v3_shop_banner
                set bn_alt        = '$bn_alt',
                    bn_url        = '$bn_url',
                    bn_device     = '$bn_device',
...
else if ($w=="d")
{
    ...
    $sql = " delete from v3_shop_banner where bn_id = $bn_id ";
...
if ($w == "" || $w == "u")
{
    ...
    goto_url("./rsc_banner_form.php?w=u&amp;bn_id=$bn_id");
} else {
    goto_url("./rsc_banner_mng.php");
}
?>
