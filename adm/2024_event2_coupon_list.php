...
?>
    ...
    <section id="anc_bo_basic">
        ...
        <form method="post" action="2024_event2_coupon_create.php">
    ...
    <form class="form-inline" name="fsearch2" action="https://epiclounge.co.kr/v3/adm/2024_event2_coupon_list_excel.php" method="get">
