        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <table class="btn_table_re" style="width:1400px;">
                ...
                while($row_track = sql_fetch_array($result_track)){
                    ...
                    $sql = "select count(*) as cnt from cb_unreal_2025_event2_apply where apply_pay_status <> 0 and apply_temp_yn = 'N'   and apply_product_code like 'NORMAL%' and apply_track = '".$track."' and (apply_product_code like '%28' or apply_product_code like '%ALL')";
                    $track_nor_28 = sql_fetch($sql);

                    $sql = "select count(*) as cnt from cb_unreal_2025_event2_apply where apply_pay_status <> 0 and apply_temp_yn = 'N'   and apply_product_code like 'STD%' and apply_track = '".$track."' and (apply_product_code like '%28' or apply_product_code like '%ALL')";
                    $track_std_28 = sql_fetch($sql);


                    $sql = "select count(*) as cnt from cb_unreal_2025_event2_apply where apply_pay_status <> 0 and apply_temp_yn = 'N'   and apply_product_code like 'NORMAL%' and apply_track = '".$track."' and (apply_product_code like '%29' or apply_product_code like '%ALL')";
                    $track_nor_29 = sql_fetch($sql);

                    $sql = "select count(*) as cnt from cb_unreal_2025_event2_apply where apply_pay_status <> 0 and apply_temp_yn = 'N'   and apply_product_code like 'STD%' and apply_track = '".$track."' and (apply_product_code like '%29' or apply_product_code like '%ALL')";
                    ...
                    <form action="2025_event2_remain_proc.php" method="post">
                        ...
                        <tr class="last">
                            ...
                            <td style="text-align: right;"><?=$track_nor_28["cnt"] + $track_std_28["cnt"]?>(일반:<?=$track_nor_28["cnt"]?>)/<?=$row_track["date1"]?></td>
                            ...
                            <td style="text-align: right;"><?=$track_nor_29["cnt"] + $track_std_29["cnt"]?>(일반:<?=$track_nor_29["cnt"]?>)/<?=$row_track["date2"]?></td>
