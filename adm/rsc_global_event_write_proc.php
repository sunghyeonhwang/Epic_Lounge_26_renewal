...
if ($is_admin != 'super') die('최고관리자만 접근 가능합니다.');
	...
	$sql = " insert into v3_rsc_global_event_bbs set 
				title = '{$_POST[title]}',
 ...
 ";
    ...
    sql_query("UPDATE v3_rsc_global_event_bbs SET ordr = {$last_idx} WHERE rsc_bbs_idx = {$last_idx}");
?>
<script>
location.href = "./rsc_global_event_list.php";
</script>