...
<form name="frm" id="frm" action="./rsc_main_res_mng_proc.php" onsubmit="return submit_frm()" method="post" enctype="multipart/form-data">
...
<div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <?php
            $bimg_str = "";
            $bimg = G5_DATA_PATH."/main_res/{$bn['bn_id']}";
            if (file_exists($bimg) && $RData['bn_id']) {
                ...
                if($size[0] && $size[0] > 750)
                    ...
                    $width = $size[0];
                $bimg_str = '<img src="'.G5_DATA_URL.'/main_res/'.$RData['bn_id'].'" width="'.$width.'">';
            }
            if ($bimg_str) {
        ...
        <tr>
            <th scope="row"><label for="bn_title">제목</label></th>
            <td colspan="2">
        ...
        <tr>
            <th scope="row"><label for="bn_tag">카테고리</label></th>
            <td colspan="2">
				  <input type="text" name="bn_tag" id="bn_tag" value="<?=$RData["bn_tag"]?>" class="frm_input frm_input_full" >
			</td>
        </tr>
        <tr>
