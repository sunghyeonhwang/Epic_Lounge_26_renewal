...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($coupon_key)) {
        ...
        if (empty($user_email) || empty($user_phone)) {
            ...
            $sql = "UPDATE cb_unreal_2025_event2_coupon_sponsor 
        ...
        if (empty($user_email) || empty($user_phone)) {
            ...
            sql_query("INSERT INTO `unrealengine`.`cb_unreal_2025_event2_coupon_sponsor_log` (`apply_no`,`old_email`, `old_phone`, `old_name`, `new_email`, `new_phone`, `new_name`, `regdate`) VALUES ('$apply_no','$old_email', '$old_phone', '$old_name', '$new_email', '$new_phone', '$new_name', now());");
...
//문자 발송 종료
        ...
        $sql = "DELETE FROM cb_unreal_2025_event2_coupon_sponsor WHERE coupon_key = '$coupon_key'";
