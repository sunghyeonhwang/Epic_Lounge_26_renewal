...
?>
    ...
    <form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
                    ...
                    <tr class="<?php echo $bg; ?>">
                       ...
                       <td>
                        ...
                        <td><select name="apply_product_code" id="apply_product_code_<?=$row['apply_no']?>" onchange="change_product('<?=$row['apply_no']?>')">
                                ...
                                <option value="NORMAL_25" <?php if($row['apply_product_code'] == 'NORMAL_25'){?>selected<?php } ?>>28일권</option>
                                <option value="NORMAL_26" <?php if($row['apply_product_code'] == 'NORMAL_26'){?>selected<?php } ?>>29일권</option>
                            </select></td>
        ...
        <script>
            function sms_send(apply_no){
                ...
                $.ajax({
                    type: "POST",
                    url: "2025_event2_list_group_sms_ajax.php",
            ...
            function change_product(apply_no){
                ...
                $.ajax({
                    type: "POST",
                    url: "2025_event2_list_group_update_ajax.php",
    ...
    <form class="form-inline" name="fsearch2" action="https://epiclounge.co.kr/v3/adm/2025_event2_list_group_excel.php" method="get">
