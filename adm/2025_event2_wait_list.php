...
$sql_common = " from cb_unreal_2025_event2_apply_inquire a ";
$sql_search = " where 1 ";
...
$sql_all_cnt = " select count(*) as cnt from cb_unreal_2025_event2_apply where apply_pay_status = 10  ";
$row_all_cnt = sql_fetch($sql_all_cnt);


$sql_free_cnt = " select count(*) as cnt from cb_unreal_2025_event2_apply  where apply_pay_status = 10 and free_yn='Y' ";
$row_free_cnt = sql_fetch($sql_free_cnt);

$sql_pay_cnt = " select count(*) as cnt from cb_unreal_2025_event2_apply  where apply_pay_status = 10 and free_yn='N' ";
$row_pay_cnt = sql_fetch($sql_pay_cnt);

$sql_refund_cnt = " select count(*) as cnt from cb_unreal_2025_event2_apply  where IFNULL(refund_date,'') <> '' ";
...
?>
    ...
    <div class="local_ov01 local_ov">
        ...
        <a href="2025_event2_list.php?sc_md=pay" class="btn btn_02 ft_11">오프라인  <?=$row_pay_cnt["cnt"]?>명</a>
        <a href="2025_event2_list.php?sc_md=free" class="btn btn_02 ft_11">온라인   <?=$row_free_cnt["cnt"]?>명</a>
    ...
    <form name="fsearch" id="fsearch" class="local_sch01 local_sch" method="get">
        ...
        <!-- <button type="button" class="btn btn-outline btn-success btn-sm" id="export_to_excel"><i class="fa fa-file-excel-o"></i> 리스트 다운로드</button> -->
    </form>
