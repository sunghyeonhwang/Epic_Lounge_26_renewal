...
$sql_common = " from cb_unreal_2024_event2_apply_live a ";
$sql_search = " where 1 ";
...
if($export == "dual"){
    $sql_common = " from cb_unreal_2024_event2_apply_live a,cb_unreal_2024_event2_apply b ";
...
if($export == "all"){
    $sql = "select count(*) as cnt from (
            select apply_user_email ,count(*) as cnt from cb_unreal_2024_event2_apply_live a 
            where 1 
            group by apply_user_email 
            )b, cb_unreal_2024_event2_apply_live l where cnt = 4 and l.apply_user_email=b.apply_user_email 
    ...
    $sql = "select count(*) as cnt from (
            ...
            where 1 
            group by apply_user_email 
            )b, cb_unreal_2024_event2_apply_live l where cnt = 4 and l.apply_user_email=b.apply_user_email and down is null
            group by l.apply_user_email order by rand() limit 0, 300";

}else if($export == "excel"){
    $sql = "select count(*) as cnt from cb_unreal_2024_event2_apply_live a , cb_unreal_2024_event2_apply b
            where 1 and a.apply_user_email=b.apply_user_email and b.apply_temp_yn = 'N' 
            order by a.apply_no desc";

}else if($export == "dual"){
    $sql = "select count(*) cnt from (
	            select count(*) as cnt from cb_unreal_2024_event2_apply_live a , cb_unreal_2024_event2_apply b 
...
if($export == "all"){
    $sql = "select * from (
            ...
            where 1 
            group by apply_user_email 
            )b, cb_unreal_2024_event2_apply_live l , cb_unreal_2024_event2_apply e
    ...
    $sql = "select * from cb_unreal_2024_event2_apply_live a, cb_unreal_2024_event2_apply b 
    ...
    $sql = "
	            select * from cb_unreal_2024_event2_apply_live a , cb_unreal_2024_event2_apply b 
                where 1 and a.apply_user_email=b.apply_user_email and b.free_yn = 'N'
            and b.apply_temp_yn = 'N'
                group by a.apply_user_email ";
}else{
...
<div class="tbl_head01 tbl_wrap">
    ...
    ?>
        ...
        <tbody>
            ...
            for ($i=1; $row=sql_fetch_array($result); $i++) {
                //$sql3 = "UPDATE cb_unreal_2024_event2_apply_live SET down = '1' WHERE apply_user_email = '".$row['apply_user_email']."'";
    ...
    <?php } else { ?>
        ...
        <tbody>
            <?php
            for ($i=1; $row=sql_fetch_array($result); $i++) {
                //$sql2 = "select * from cb_unreal_2024_event2_apply where apply_user_email = '".$row['apply_user_email']."' limit 1";
                //$row2 = sql_fetch($sql2);
            ?>
                <tr>
                    <td>
