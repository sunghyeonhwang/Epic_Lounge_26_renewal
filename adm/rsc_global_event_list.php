...
if(!empty($_GET[sc_text])){
	...
	$sql_list_cnt = 
		" select count(*) cnt from v3_rsc_global_event_bbs 
		  where 1=1 " 
		  . $where . " ";
...
<form name="frm_delete" id="frm_delete" action="./rsc_global_event_list_proc.php" method="post">
...
?>
        ...
        <td class="">
            <a href="./rsc_global_event_modify.php?rsc_bbs_idx=<?=$row_list["rsc_bbs_idx"]?>" class="btn btn_03 margin_b_5">수정</a><br />
...
<div class="btn_fixed_top">
        <input type="button" onclick="group_delete()" name="" value="선택삭제" onclick="" class="btn_02 btn">
            <a href="./rsc_global_event_write.php" id="bo_add" class="btn_01 btn">이벤트 추가</a>
    </div>
...
<script>
	...
	function ajax_module(idx,field,value,mode){
		$.ajax({
			type : 'post',
			url : "./rsc_global_event_list_proc.php",
    ...
    function move_to(mode, idx,field){
        $.ajax({
            ...
            data : {'mode':'global_event','idx': idx,'move':mode},
            dataType : 'json',
            success : function(json) {
