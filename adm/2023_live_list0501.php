...
<select class="" name="apply_reg_datetime">
    ...
    <option value="2023-08-29" <?php if($apply_reg_datetime == '2023-08-29'){?>selected<?php } ?>>day1</option>
    <option value="2023-08-30" <?php if($apply_reg_datetime == '2023-08-30'){?>selected<?php } ?>>day2</option>
    <option value="2023-08-31" <?php if($apply_reg_datetime == '2023-08-31'){?>selected<?php } ?>>day3</option>
    <option value="2023-09-01" <?php if($apply_reg_datetime == '2023-09-01'){?>selected<?php } ?>>day4</option>
...
<input type="submit" value="검색" class="btn_submit">
    ...
    <!--<button type="button" class="btn btn-outline btn-success btn-sm" id="export_to_excel15"><i class="fa fa-file-excel-o"></i> 검색 시청 15명 랜덤 추출</button>-->
...
<form class="form-inline" name="fsearch2" action="https://epiclounge.co.kr/v3/adm/2023_export_excel_live.php" method="get">
