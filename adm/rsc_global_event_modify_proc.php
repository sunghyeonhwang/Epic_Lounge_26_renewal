...
if ($is_admin != 'super') die('최고관리자만 접근 가능합니다.');
    ...
    if ($_FILES['thumb_img']['name']) {
		...
		$sql = " update v3_rsc_global_event_bbs 
	...
	$sql = " update v3_rsc_global_event_bbs set 
				title = '{$_POST[title]}',
...
?>
<script>
location.href = "./rsc_global_event_modify.php?rsc_bbs_idx=<?=$_POST["rsc_bbs_idx"]?>";
</script>