...
$offline_cnt = sql_fetch("select count(*) as cnt from (select count(*) as cnt from cb_unreal_2024_event2_apply_live l,cb_unreal_2024_event2_apply e where l.apply_user_email=e.apply_user_email and e.free_yn = 'N' and (e.apply_pay_status = 10 or e.apply_pay_status = 1)  group by l.apply_user_email)b");
$online_cnt = sql_fetch("select count(*) as cnt from (select count(*) as cnt from cb_unreal_2024_event2_apply_live l,cb_unreal_2024_event2_apply e where l.apply_user_email=e.apply_user_email and e.free_yn = 'Y'  group by l.apply_user_email)b");
?>
...
<select class="" name="apply_reg_datetime">
    ...
    <option value="2024-08-28" <?php if($apply_reg_datetime == '2024-08-28'){?>selected<?php } ?>>2024-08-28</option>
    <option value="2024-08-29" <?php if($apply_reg_datetime == '2024-08-29'){?>selected<?php } ?>>2024-08-29</option>
...
<form class="form-inline" name="fsearch2" action="https://epiclounge.co.kr/v3/adm/2024_export2_excel_live.php" method="get">
