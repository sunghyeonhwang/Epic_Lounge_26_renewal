...
?>
					<tr>
						...
						<td><a href="#b" onclick="delete_rsc('./rsc_review_mng_proc.php?rsc_idx=<?=$row["rsc_idx"]?>&mode=delete','<?=$row["rsc_name"]?>')" class="btn btn_05">삭제</a></td>
					</tr>
<?
	}
?>
...
?>
        ...
        <tr>
            <th scope="row" class="text_center"><label for="bo_table">난이도</label></th>
            <td>
...
?>
				...
				<tr class="last">
					<td colspan="4">
		                <input type="text" name="bo_table" value="" id="bo_table" class="frm_input" maxlength="30"> <a href="#n" onclick="insert_rsc('난이도',this)" class="btn btn_03">추가</a>
				</td>
              </tr>
				</tbody>
				</table>
...
function insert_rsc(cate,frm){
	...
	if(confirm(cate+"카테고리에 "+add_text+"를 추가하시겠습니까?")){
		location.href = "./rsc_review_mng_proc.php?rsc_name="+add_text+"&rsc_type="+cate+"&mode=insert";
	}
