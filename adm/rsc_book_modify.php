...
$RData = sql_fetch("select * from v3_rsc_book_bbs where rsc_bbs_idx = '{$idx}'");

?>


<form name="frm_bbs" id="frm_bbs" action="./rsc_book_modify_proc.php" enctype="multipart/form-data" onsubmit="return submit_frm()" method="post">
