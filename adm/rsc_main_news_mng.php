...
$sql_common = " from v3_main_banner_news ";
...
<div class="btn_fixed_top">
    <a href="./rsc_main_news_form.php" class="btn_01 btn">배너추가</a>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <?php
    $sql = " select * from v3_main_banner_news $sql_search
    ...
    <tr>
		...
		<td><img src="/v3/data/main_news/<?php echo $row['bn_id']; ?>" class="main_news_img1" width="100px" /></td>
		...
		<td>
            <a href="./rsc_main_news_form.php?bn_id=<?=$row["bn_id"]?>&w=u" class="btn btn_03">수정</a>
            <a href="./rsc_main_news_mng_proc.php?w=d&amp;bn_id=<?php echo $row['bn_id']; ?>" onclick="return delete_confirm(this);" class="btn btn_02">삭제</a>
        </td>
    </tr>
    <?php
    }
