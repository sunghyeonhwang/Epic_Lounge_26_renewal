    ...
    <div class="tbl_head01 tbl_wrap">
        <table>
            ...
            for ($i=1; $row=sql_fetch_array($result); $i++ ) {
                ...
                //$sql_user = sql_fetch("select count(*) cnt from cb_unreal_2025_event2_apply where mpay_tid = '".$tid."' or pay_tid = '".$tid."' ");
                $sql_user = sql_fetch("select * from cb_unreal_2025_event2_apply where mpay_tid = '".$tid."' or pay_tid = '".$tid."' ");
                //$sql_user = sql_fetch("select count(*) cnt from cb_unreal_2025_event2_apply where mpay_tid = '".$tid."' or pay_moid = '".$MOID."' ");
