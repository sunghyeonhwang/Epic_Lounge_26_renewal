...
$sql_common = " from v3_shop_banner ";
...
<div class="btn_fixed_top">
    <a href="./rsc_banner_form.php" class="btn_01 btn">배너추가</a>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="th_dvc">링크주소</th>
    ...
    <tbody>
    <?php
    $sql = " select * from v3_shop_banner $sql_search
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="th_dvc"><?php echo $row['bn_url']; ?></td>
        ...
        <td headers="th_mng" class="td_mng td_mns_m">
            <a href="./rsc_banner_form.php?w=u&amp;bn_id=<?php echo $row['bn_id']; ?>" class="btn btn_03">수정</a>
            <a href="./rsc_banner_mng_proc.php?w=d&amp;bn_id=<?php echo $row['bn_id']; ?>" onclick="return delete_confirm(this);" class="btn btn_02">삭제</a>
        </td>
    </tr>
    <tr class="<?php echo $bg; ?>">
